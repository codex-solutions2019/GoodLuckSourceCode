                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> liam@gmail.com
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-cell-phone p-0 me-2"></span> 0126595743
                            </div>
                          </td>
                          <td>Dr. Benjamin</td>
                          <td>mumps</td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> emma@gmail.com
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> olivia@gmail.com
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> ava@gmail.com
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> noah@gmail.co
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> isabella@gmail.com
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center nowrap text-primary">
                              <span class="icofont-ui-email p-0 me-2"></span> sophia@gmail.com
                            </div>
                          </td>
                          <td>
