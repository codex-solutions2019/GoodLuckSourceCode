...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                 <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Add Country
                                            </h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="immigration_country" name="immigration_country" class="form-control"
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" id="immmigration_file" name="immigraion_file" type="file">
                                        </div>
                                    </div>
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                         ...
                                         <select class="form-control" id="immigration_status" name="immigration_status">
    ...
    <div class="modal fade" id="edit_immigration_locations" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                 <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Edit Country
                                            </h5>
                                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                            </button>
  ...
  $('.summernote').summernote({
	...
	<script>
      ...
      $('#add_immigration').on('submit', function(e){  
                ...
                $.ajax({  
                     url:"<?php echo base_url(); ?>Immigration_api/create_immigrationlocations",
                     method:"POST",  
                     data:privacy_editor,  
                     contentType: false,  
                     cache: false,  
   ...
   <script>function delete_immigration_locations(id){
        //   alert(id);
        if(confirm('Are you sure to remove this record ?'))
        {
            
           
          $.post("<?=base_url()?>Immigration_api/delete_immigrationlocations",{'id':id},function(data)
             {
                location.reload();
             })
        }
